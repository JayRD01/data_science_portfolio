# ds_sync_store — Installation Guide
...
conda activate ds_sync_store
```

Or with **mamba**:
```bash
mamba env create -f environment.yml
mamba activate ds_sync_store
```
...
Now you can import your local modules directly from the `ds_sync_store/` folder.
...
Example usage:
```python
from ds_sync_store.utils.paths import data_dir
data_dir()
```
